...
func (m *PerNetworkOptions) validateStaticMac(formats strfmt.Registry) error {
...
func (m *PerNetworkOptions) contextValidateStaticMac(ctx context.Context, formats strfmt.Registry) error {
